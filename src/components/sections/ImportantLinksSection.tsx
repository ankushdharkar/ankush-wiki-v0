      ...
      <div className="container mx-auto px-6">
        ...
        <RevealAnimation delay={0.2}>
          <div className="text-center mb-16">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 text-white">Important Links</h2>
        ...
        <div className="mb-16">
          <RevealAnimation delay={0.4}>
            <div className="text-center mb-8">
              <h3 className="text-xl md:text-2xl font-semibold mb-4 flex items-center justify-center gap-2 text-white">
        ...
        <div className="mb-16">
          <RevealAnimation delay={0.6}>
            <div className="text-center mb-8">
              <h3 className="text-xl md:text-2xl font-semibold mb-4 text-white">Coming Soon</h3>
        ...
        <RevealAnimation delay={1.2}>
          <div className="text-center mt-16">
            <p className="text-gray-300 mb-6">Check out more content and updates</p>
