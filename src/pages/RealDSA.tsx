...
export default function RealDSA() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white transition-colors">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-orange-100 dark:bg-orange-900/40 text-orange-700 dark:text-orange-300 text-sm font-bold mb-8 border border-orange-200 dark:border-orange-600/50 shadow-lg shadow-orange-500/10"
            >
            ...
            >
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="group relative px-10 py-5 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white font-bold text-xl rounded-2xl shadow-xl shadow-orange-500/30 hover:shadow-orange-500/50 transition-all duration-300 overflow-hidden"
              >
                {/* Shine effect */}
              ...
              <a
                href="#curriculum"
                className="px-8 py-4 border-2 border-orange-500 dark:border-orange-400 text-orange-700 dark:text-orange-300 hover:bg-orange-500 hover:text-white dark:hover:bg-orange-500 dark:hover:text-white font-bold text-lg rounded-2xl transition-all duration-300"
              >
                View Curriculum
              </a>
            </motion.div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                <div className="text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-orange-500 to-amber-500 bg-clip-text text-transparent mb-2">
                  {stat.value}
                </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-xl hover:shadow-orange-500/10 transition-all duration-300"
              >
      ...
      {/* Curriculum Section */}
      <section id="curriculum" className="py-24 bg-gradient-to-b from-orange-50 to-white dark:from-gray-800 dark:to-gray-900">
        <div className="container mx-auto px-6">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
      ...
      <section className="py-24">
        <div className="container mx-auto px-6">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="max-w-4xl mx-auto text-center bg-gradient-to-r from-orange-500 to-amber-500 rounded-3xl p-12 md:p-16 shadow-2xl shadow-orange-500/30"
          >
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center gap-3 px-10 py-5 bg-white text-orange-600 font-bold text-xl rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300"
            >
              Get Started Now
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
